...
class Kemeng_model extends CI_Model
{
    ...
    public function login($game_id)
    {
        ...
        $this->cache->save('kemeng_pkg', $pkg);
    ...
    public function trun_to_game($game_id)
    {
        ...
        // if ($pkg=='lcby_mszs_O'||$pkg=='lcby_cq176_AX'||$serverId==7||$serverId==1) {
        // if ($serverId>=1&&$serverId<1026) {
        if ($game_id == 1060) {
            $game_url='https://lcby.gz.1251208707.clb.myqcloud.com/dkm/login/serverlist';
        } elseif ($game_id == 1089) {
            // $game_url='https://lcby.gz.1251208707.clb.myqcloud.com/yuewan/login/dkm';

            $game_url='https://lcby.gz.1251208707.clb.myqcloud.com/yuewan/login/serverlist';
        }
