...
class Azwdone_model extends CI_Model
{
    public $platform = 'Azwdone';
...
//             self::ipaynow('13','2',$notify_url,$game_order->money,$goodsName,$game_order->u_order_id);
