...
class Fivegame_model extends CI_Model
{
    public $platform = 'fivegame';
    ...
    public function get_order_id()
    {
        ...
        $secret=$this->Game_model->get_key($game_id, 'APPSecret');
        $mysign = md5("payid=$payid$secret");
        $check_url = "http://5wanpk.com/open/usergetpayinfo?payid=$payid&sign=$mysign";
        $this->load->model('Curl_model');
        $response =json_decode($this->Curl_model->curl_get($check_url)) ;
