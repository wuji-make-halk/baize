...
class Baoge_model extends CI_Model
{
    public $platform = 'baoge';
            ...
            if ($content) {
                ...
                if (!isset($res->code)) {
                    ...
                    $h5data = array(
                        'tid' => $transid,
                        'app' => '3012208265',
                        'url_r' => 'http://'.$_SERVER['HTTP_HOST'].'/index.php/enter/play/' . $this->platform . '/' . $_game_id,
                        'url_h' => 'http://'.$_SERVER['HTTP_HOST'].'/index.php/enter/play/' . $this->platform . '/' . $_game_id,
                        'ptype' => '403',
                    );
