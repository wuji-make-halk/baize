...
class Yinli_model extends CI_Model
{
    public $platform = 'yinli';
    ...
    public function get_order_id()
    {
        ...
        log_message('debug',$this->platform.' post '.$request);
        // echo urlencode($request);
        $request = json_decode(urldecode($request));
        $orderId = $request->ext1;
        $money = $request->payCost;
