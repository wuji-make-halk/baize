...
class Xingjiehuyu_model extends CI_Model
{
    public $platform = 'xingjiehuyu';
                ...
                $res = json_decode(urldecode($ps['transdata']));
                    ...
                    if (!isset($res->code)) {
                        ...
                        $h5data = array(
                            'tid' => $transid,
                            'app' => '3012208265',
                            'url_r' => 'http://h5sdk-xly.xileyougame.com/index.php/enter/play/xingjiehuyu/1446',
                            'url_h' => 'http://h5sdk-xly.xileyougame.com/index.php/enter/play/xingjiehuyu/1446',
                            'ptype'=>'403'
                        );
            ...
            if ($content) {
                ...
                if (!isset($res->code)) {
                    ...
                    $h5data = array(
                        ...
                        'url_r' => 'http://h5sdk-xly.xileyougame.com/index.php/enter/play/bgm/1435/',
                        'url_h' => 'http://h5sdk-xly.xileyougame.com/index.php/enter/play/bgm/1435/',
                    );
                    if ($game_id==1084) {
    ...
    public function focus()
    {
        ...
        // $url = 'http://h5sdk-xly.xileyougame.com/index.php/enter/play/bgm/1435/index.php/api/focus?openid='.$user->p_uid;
    ...
    public function login_collect($data)
    {
        ...
        // $url = "http://h5sdk-xly.xileyougame.com/index.php/enter/play/bgm/1435/tongji/tongji_game_login/{$user_id}/{$game_id}/{$access_token}";
    ...
    public function create_role_collect($data)
    {
        ...
        $user_id = $data['p_uid'];
        $game_id = $data['game_id'];
        // $url = "http://h5sdk-xly.xileyougame.com/index.php/enter/play/bgm/1435/tongji/tongji_create_role/{$user_id}/{$game_id}/{$access_token}";
        $this->Curl_model->curl_get($url);
    }
