...
class Mailiangceshione_model extends CI_Model
{
    public $platform = 'mailiangceshione';
                ...
                $res = json_decode(urldecode($ps['transdata']));
                    ...
                    if (!isset($res->code)) {
                        ...
                        $h5data = array(
                            'tid' => $transid,
                            'app' => '3012208265',
                            'url_r' => 'http://h5sdk-xly.xileyougame.com/index.php/game/redirect/41',
                            'url_h' => 'http://h5sdk-xly.xileyougame.com/index.php/game/redirect/41',
                        );
    ...
    public function get_order_id()
    {
        ...
        $order_id = $this->input->get_post('cporderid');
