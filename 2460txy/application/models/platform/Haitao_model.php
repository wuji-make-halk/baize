...
class Haitao_model extends CI_Model
{
    public $platform = 'haitao';
                ...
                $res = json_decode(urldecode($ps['transdata']));
                    ...
                    if (!isset($res->code)) {
                        ...
                        $h5data = array(
                            'tid' => $transid,
                            'app' => '3012208265',
                            'url_r' => 'http://h5.allugame.com/index.php/game/redirect/62',
                            'url_h' => 'http://h5.allugame.com/index.php/game/redirect/62',
                            'ptype'=>'403'
                        );
