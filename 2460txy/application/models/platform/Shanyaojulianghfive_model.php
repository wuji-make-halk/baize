...
class Shanyaojulianghfive_model extends CI_Model
{
    public $platform = 'shanyaojulianghfive';
    ...
    public function login($game_id)
    {
        ...
        log_message('debug', "$platform login get user_id: $user_id");
    ...
    public function focus($game_id = '')
    {
        ...
        $requery = json_decode($this->Curl_model->curl_get('http://h5.sdk.quicksdk.net/webGameApi/getUserInfo?token='.$token));
        $data = array(
            'productCode' => $productCode,
            'productKey' => $productKey,
            'channel_id' =>$requery->data->channelId,
            'user_id'=>$requery->data->uid,
