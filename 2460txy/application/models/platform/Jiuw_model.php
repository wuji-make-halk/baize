...
class Jiuw_model extends CI_Model
{
    public $platform = 'jiuw';
    ...
    public function get_order_id()
    {
        ...
        if ($order_id && $money) {
            ...
            $my_sign = md5("source=$source&trade_no=$order_id&out_trade_no=$out_trade_no&amount=$money&game_appid=$this->appid&key=$this->key");
