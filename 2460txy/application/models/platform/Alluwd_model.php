...
class Alluwd_model extends CI_Model
{
    public $platform = 'alluwd';
    ...
    {
        // if ($game_id == 1084 || $game_id == 1087 || $game_id == 1127|| $game_id == 1128) {
            $game_id = 1000;
    ...
    {
        // log_message('debug',$this->platform.' order info '.json_encode($_REQUEST));
