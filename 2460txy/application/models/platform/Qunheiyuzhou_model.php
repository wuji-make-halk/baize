...
class Qunheiyuzhou_model extends CI_Model
{
    public $platform = 'qunheiyuzhou';
    public $charge_key = '';
    public $login_key = '0986ebc2fa9e7e1d74f9fd8d73f41e7e';
    ...
    public function trun_to_game($game_id)
    {
        ...
        log_message('debug', "qunheiyuzhou login:$url");
