...
class Allutest_model extends CI_Model
{
    public $platform = 'allutest';
    ...
    public function login()
    {
        ...
        //     return false;
        // }
        // $url = "http://h5.zytxgame.com/index.php/api/get_user_info?token=$token&uid=$user_id";
    ...
    public function sign_order($game_id = '')
    {
        if ($game_id = 1084 || $game_id = 1087) {
            ...
            $transdata['currency'] = 'RMB';
            $transdata['appuserid'] = "$openId";
            $transdata['notifyurl'] = 'http://h5.xileyougame.com/index.php/notify/aibei';
