...
class Qidianyule_model extends CI_Model
{
    public $platform = 'qidianyule';
    ...
    public function get_order_id()
    {
        ...
        log_message('debug', $this->platform.' orderid is:'.$order_id.' and money is : '.$money.' '.json_encode($_POST));
        if ($order_id && $money) {
    ...
    public function sign_order($game_id = '')
    {
        ...
        $sign = $this->signData($sign_data, $key);
    ...
    private function signData($data, $game_key)
    {
        ...
        // $this->Output_model->json_print(-1, 'cc test str', $str);
        log_message('debug', $this->platform.' ' .$str .' '.md5($str). ' ');
        return md5($str);
    }
