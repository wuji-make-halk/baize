...
class Gowanmemlzf_model extends CI_Model
{
    public $platform = 'gowanmemlzf';
...
//         log_message('error', " Gowanme not  ".$order_id.'   '.substr(md5(md5($order_id).sha1($order_id)),20));
        $url="http://api.baizegame.com/index.php/api/notify/gowanmemlzf/$game_id?".http_build_query($post_data);
