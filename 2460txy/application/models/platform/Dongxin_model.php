...
class Dongxin_model extends CI_Model
{
    public $platform = 'dongxin';
                ...
                $res = json_decode(urldecode($ps['transdata']));
                    ...
                    if (!isset($res->code)) {
                        ...
                        $h5data = array(
                            'tid' => $transid,
                            'app' => '3012208265',
                            'url_r' => 'http://h5sdk-xly.xileyougame.com/index.php/enter/play/dongxin/1442',
                            'url_h' => 'http://h5sdk-xly.xileyougame.com/index.php/enter/play/dongxin/1442',
                            'ptype'=>'403'
                        );
