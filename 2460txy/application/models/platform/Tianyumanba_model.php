...
class Tianyumanba_model extends CI_Model
{
    public $platform = 'tianyumanba';
    ...
    {
        $CPgameid = $this->input->get('mbGameId');
        $user_id = $this->input->get('mbUserId');
        $token = $this->input->get('mbToken');
    ...
    public function get_order_id()
    {
        ...
        $custom_info = $this->input->get_post('out_order_no');
