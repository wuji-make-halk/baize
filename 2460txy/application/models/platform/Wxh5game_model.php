...
class Wxh5game_model extends CI_Model
{
    public $platform = 'Wxh5game';
    ...
    public function login($game_id)
    {
        ...
        $uid = $this->input->get('wx_guid'); //uid用户唯一unionid
        $condition = array(
            'user_id' => $uid,
            'platform' => 'wxminigame',
            'game_id'=>$game_id,
...
//             $app_secret='0dfbbd3b0b5dc79407d4bab465947681';
            ...
            $pay_appid = 'wx375234cb72d3b9bd';//商户号appid
            $pay_key = '53b5edd4e9c38f6fdc95ab936ccbbf5f';//商户号秘钥
            $mchid = '1560006701';
            $apikey = 'mdy0y4htai4kbxw1uke526nh17g3ybbt';
            $mchid_type = '701';

//            $pay_appid = 'wxfe535376cd95ff9e';//服务号appid
//            $pay_key = 'cd502521f75fe8c359bcd3f3d1deec0f';//服务号秘钥
//            $mchid = '1535960531';
//            $apikey = 'Bre0ly3bxa6jz7d4l9rwfuyui6g4ft7Z';
//            $mchid_type = '531';
            ...
            if($is_status=='2' || $is_status == '1'){
                ...
                log_message('debug', 'test_h5pay3:'.json_encode($result));
            ...
            $resUrl = 'http://api.baizegame.com/wxh5pay_test.html?'.$url_parmas;

//            $new_url_parmas=http_build_query( array(
                //$result->mweb_url,
//                'wx_pay_url'=>$resUrl,
//                'goodsName'=>$goodsName,
...
//            ));
    ...
    private function ipaynow($payChannelType,$outputType,$notify_url,$money,$goods_name,$order_id){
        ...
        $req["mhtSubAppId"]       = '' ;//商户appid outputType=1且paychannelType=13时必传
        $req["consumerId"]        = ''  ;//消费者ID outputType=1必填
        $req["deviceType"]        = '0600';
