...
class Ntss_model extends CI_Model
{
    public $platform = 'ntss';
    ...
    {
        $uid = $this->input->get('username');    //用户id
        $timestamp = $this->input->get('timestamp');    //用户id
        $sign = $this->input->get('sign');    //用户id
