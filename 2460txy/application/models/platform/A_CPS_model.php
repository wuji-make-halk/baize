...
class Hefangtwo_model extends CI_Model
{
    public $platform = 'hefangtwo';
                ...
                $res = json_decode(urldecode($ps['transdata']));
                    ...
                    if (!isset($res->code)) {
                        ...
                        $h5data = array(
                            'tid' => $transid,
                            'app' => '3012208265',
                            'url_r' => 'http://h5sdk-xly.xileyougame.com/index.php/enter/play/'.$this->platform.'/'.$game_id,
                            'url_h' => 'http://h5sdk-xly.xileyougame.com/index.php/enter/play/'.$this->platform.'/'.$game_id,
                            'ptype'=>'403'
                        );
