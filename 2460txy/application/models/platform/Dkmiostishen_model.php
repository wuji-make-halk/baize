...
class Dkmiostishen_model extends CI_Model
{
    public $platform = 'dkmiostishen';
    ...
    public function login($game_id)
    {
        ...
        log_message('debug', $this->platform.' userid is '.$uid);
        $account = $this->input->get('account');
        $token = $this->input->get('token');
        $pkg = $this->input->get('pkg');
        $this->session->set_userdata('kemengus_pkg', $pkg);
        log_message('debug', $this->platform.' pkg is '.$pkg);
    ...
    public function trun_to_game($game_id)
    {
        ...
        $pkg = '';
        log_message('debug', $this->platform.' turn to game pkg is '.$pkg);
        $noice = time();
        ...
        log_message('debug', "kemengus login:$url");
