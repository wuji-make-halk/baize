...
class Xyouwang_model extends CI_Model
{
    public $platform = 'xyouwang';
    ...
    public function get_order_id()
    {
      ...
      $custom_info = $this->input->get_post('app_ext1');
    ...
    public function sign_order($game_id = '')
    {
        ...
        $gameUid = $this->input->get('gameUid');
        ...
        $time = time();
        $sign=md5("ext=$order_id"."gameId=$gameId"."goodsId=$money"."secret=$secret"."time=$time"."userId=$uid");
        $post_data = array(
            'gameId'=>$gameId,
            'goodsId'=>$money,
            'goodsName'=>'元宝',
