...
class Qimiaoios_model extends CI_Model
{
    public $platform = 'qimiaoios';
    ...
    public function trun_to_game($game_id)
    {
        ...
        // $game_url = 'https://lcby.gz.1251208707.clb.myqcloud.com/qimiao/login/dkm';
    ...
    public function get_order_id()
    {
        ...
        // $this->session->set_userdata('game_id', $my_game_id);
        // if ($my_sign==$sign) {
        // echo $order_id;
        return $order_id;
        // } else {
    ...
    public function notify_ok()
    {
        ...
        // $pkg = $this->session->userdata('9130_game_pkg');
        // $sign = md5($order_id.$uid  .$product_id . $money .$role_id . $server_id . $partner_id  . $time . $key);
        // $data = array(
        //     'order_id' => $order_id,
        //     'uid' => $uid,
