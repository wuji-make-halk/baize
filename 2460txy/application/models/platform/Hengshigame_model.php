...
class Hengshigame_model extends CI_Model
{
    public $platform = 'hengshigame';
    ...
    public function login($game_id)
    {
        ...
        $playersex = $this->input->get('playersex');
    ...
    {
        $orderId = $this->input->get_post('custom');
        $openid = $this->input->get_post('openid');
        $gameid = $this->input->get_post('gameid');
        $serverid = $this->input->get_post('serverid');
        $cp_orderid = $this->input->get_post('orderid');
        $recharge = $this->input->get_post('recharge');
        ...
        $key=$this->Game_model->get_key($game_id, 'paymdkey');
        $my_sign=md5("openid=$openid&gameid=$gameid&serverid=$serverid&orderid=$cp_orderid&recharge=$recharge&custom=$custom&timestamp=$timestamp&mdkey=$key");
        // if (intval($recharge*100)!=$game_order->money) {
        //     return;
        // }else{
        //     return $orderId;
        // }
