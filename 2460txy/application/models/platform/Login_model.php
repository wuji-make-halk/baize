...
class Login_model extends CI_Model
{
    ...
    public function sign_order($game_id = '')
    {
        if ($game_id != 1000) {
            ...
            $platpkey = 'MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQC7jYUq3QDoAy63+CmVUd0dWPQbA0OjDHGH67vHSQK+fb/zGLJpdDklIUYw0q7zkxWgZ/tRWtVAdEdtrSb5veDS2LFcK0OFTjCqwptwzYUlpfgUivZN6+ARGl40UY0P8qNv/z60F2+QjO//gmnRwBVGI5dvaT3C6XLD11TSC72uVQIDAQAB';
            ...
            $url = 'http://'.$_SERVER['HTTP_HOST'].'/index.php/api/app_order?';
            $url .= 'uid=' . $userId;
            $url .= '&game_id=' . $game_id;
            ...
            $url .= '&notify=' . $_SERVER['HTTP_HOST'].'/index.php/api/notify/alluapp/1058';
