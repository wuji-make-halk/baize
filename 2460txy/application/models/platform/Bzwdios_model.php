...
class Bzwdios_model extends CI_Model
{
    public $platform = 'Bzwdios';
...
//             $pay_appid='wx17c8eab06395622a';
            $notify_url=$url = "http://".$_SERVER['HTTP_HOST']."/index.php/api/notify/$this->platform";
//             $mchid='1535960531';
...
//            $response=$this->Curl_model->curl_get($result->mweb_url,array('Referer'=>'http://api.baizegame.com/',
...
//            log_message('debug', "wxpay h5 log : ".$response);
            ...
            $url_parmas=http_build_query( array(
                ...
                'ali_pay_url'=>"http://".$_SERVER['HTTP_HOST']."/index.php/alipay/alipay2?order_id=".$game_order->u_order_id,
            ));
            log_message('debug', "allu login:$game->platform_key");
            log_message('debug', "allu login:",$this->appstore_bundleid[$appstore['bundleid']][abs(sprintf("%.2f",$money))]);
            $appstore=json_decode($game->platform_key,true);
            if($appstore['appstore']){
                $data = array(
                    'pay_url' => $this->appstore_bundleid[$appstore['bundleid']][abs(sprintf("%.2f",$money))],
                    'appstore'=>1,
                    'order_id'=>$game_order->u_order_id,
                );
            }else{
    ...
    private function ipaynow_notify(){
        $testxml = file_get_contents("php://input");
                log_message('debug', "ipaynow post data 2".json_encode($testxml));
    ...
    public function get_order_id()
    {
        ...
        if($this->input->get('appstore')==1){
            self::other_report($game_order,'appstore');
        }else{
    ...
    public function other_report($parmas,$pay){
        ...
        $user = $this->User_model->get_one_by_condition($condition);
        if ($parmas->game_id=='29' && $parmas->report=='0'){
    ...
    public $appstore_bundleid=array(
        'com.mhxj.5eyx.df'=>array(
            12=>'com.mhxj.cz12',
            30=>'com.mhxj.cz30',
            50=>'com.mhxj.cz50',
            98=>'com.mhxj.cz98',
        ...
        'yxxjwd.jin.game'=>array(
            12=>'yxxjwd.jin.game.12',
            30=>'yxxjwd.jin.game.30',
            50=>'yxxjwd.jin.game.50',
            98=>'yxxjwd.jin.game.98',
            148=>'yxxjwd.jin.game.148',
            198=>'yxxjwd.jin.game.198',
            328=>'yxxjwd.jin.game.328',
            648=>'yxxjwd.jin.game.648',
        ),
        'com.fk.mhsj.3nt'=>array(
            12=>'com.fk.mhsj.ybb12',
            30=>'com.fk.mhsj.ybb30',
            50=>'com.fk.mhsj.ybb50',
            98=>'com.fk.mhsj.ybb98',
            148=>'com.fk.mhsj.ybb148',
            198=>'com.fk.mhsj.ybb198',
            328=>'com.fk.mhsj.ybb328',
            648=>'com.fk.mhsj.ybb648',
        ),
    );
