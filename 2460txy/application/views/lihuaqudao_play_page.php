...
<head>
    ...
    <script src='/js/jssdk/lihuaqudao_g2b.js?v=<?php echo time(); ?>'></script>
    <style type="text/css">
        html {
            height: 100%;
            background-color: black;
            background-color: black;
            <?php echo 'background-image: url("http://cdn-hxxyh5.hxyxsj.com/webqmx/webqmx1.0.0d/resource/ui/image/dengLu/dl_ztBg01.jpg");';
...
<body scroll='no' style='background-color:black; margin-left:0px;'>
...
<div id="loginBox" style="width:100%;height:100%;background-color:rgba(0,0,0,0.5);position: fixed;left:0;top:0;z-index:999999;display:none;" alt="遮罩">
