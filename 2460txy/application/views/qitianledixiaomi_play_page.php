...
<head>
    ...
    <script src='/js/jssdk/qitianledixiaomi_g2b.js?v=<?php echo time(); ?>'></script>
    <script type="text/javascript" defer="defer" src="//static.g.mi.com/game/h5sdk/h5-wy-sdk-v.1.0.min.js"> </script>
