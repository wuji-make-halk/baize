...
<head>
    ...
    <script src='/js/jssdk/sina_g2b.js'></script>
	...
	<script type="text/javascript">
		...
		function showPreScreen(){
			...
			if(isAndroid){
				...
				frameWidth = window.innerWidth||document.documentElement.clientWidth;
				console.log('frameWidth : '+frameWidth);
				frameHeight = window.innerHeight||document.documentElement.clientHeight;
				console.log('frameHeight : '+frameHeight);
			}
