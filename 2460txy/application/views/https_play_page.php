...
<head>
    ...
    <script src='/js/g2b_loader.js'></script>
    <script src="/js/PV_count/h_20000.js" charset="utf-8"></script>
	<style type="text/css">
	...
	<script type="text/javascript">
		...
		var gameAppId = 1056;
		var infos = {  "chengt":"{\"passType\":\"QHSER\"}"}
...
<body scroll='no' style='background-color:white'>
	<iframe scrolling="no" id="gameFrame" src="<?php echo $url?>&amp;frameHeight=706&amp;frameWidth=428" style="width: 428px; height: 706px; margin: auto; position: absolute; top: 0px; left: 0px; background-color: white; border: none; z-index: 99;"></iframe>
