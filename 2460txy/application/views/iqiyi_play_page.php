...
<head>
    ...
    <script src='/js/g2b_loader.js?v=6'></script>
	...
	(function(window) {
		...
		window.top.postMessage(obj1, 'http://togame.pps.tv ');
		window.top.postMessage(obj1, 'http://togame.iqiyi.com ');
		window.top.postMessage(obj1, 'http://playgame.pps.tv ');
		window.top.postMessage(obj1, 'http://playgame.iqiyi.com ');
		window.top.postMessage(obj1, 'http://playgame2.iqiyi.com');
	})(window);
