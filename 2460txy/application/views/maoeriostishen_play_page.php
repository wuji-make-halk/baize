...
<head>
    ...
    <script src='/js/jssdk/maoeriostishen_g2b.js?v=<?php echo time();?>'></script>
	<script src='https://download.maoergame.com/js/mrsdk.js'></script>
	...
	<style type="text/css">
		html{
			...
			<?php
            //if($appId==1291||$appId==1292){
                // echo 'background-image: url("/img/login/huawei/xjrm.jpg");';
								echo 'background-image: url("/img/login/huawei/lj.2.jpg");';

            //} else if($appId==1285){
            //	echo 'background-image: url("/img/login/huawei/xjl.jpg");';
            //} else if($appId==1293){
            //	echo 'background-image: url("/img/login/huawei/wxx.jpg");';
            //}
            ?>
	...
	<script type="text/javascript">
		// (function(window) {
		// 	window.top.location.href  = "http://h5sdk-xly.xileyougame.com/index.php/enter/play/maoer/1367";
		// })(window);
