...
<head>
	...
	<style type="text/css">
		html{height:100%;background-color:black; <?php
			...
			setTimeout(function(){
				...
				switch(passId){
                    ...
                    case "gowanme":
                        ...
                        g2b.loadScript("//h5sdk.gowan8.com/h5sdk/h5sdk.js", function() {
                            kkkSDK.init().then(function(res) {
                            	console.log('初始化成功：', res);
                                if(res.statusCode==0){
                                    kkkSDK.login().then(function(res) {
                               	 		console.log('登录成功：', res)
                               	 		var param = res.loginParams;
											 gowanme_param = param;
											 (param['ext'].is_activity ==1)?param['is_activity']=1:param['is_activity']=0;
                                   	 		delete param['ext'];
                                       	 	delete param['cp_ext'];
