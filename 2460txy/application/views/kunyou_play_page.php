...
<head>
    ...
    <script src='/js/jssdk/kunyou_g2b.js?v=<?php echo time();?>'></script>
    <script src="/js/h.js" charset="utf-8"></script>
    <script src="//kyh5sdk.oss-cn-beijing.aliyuncs.com/sdk_js/jquery.min.js?v="<?php echo time();?>></script>
    <script src="//kyh5sdk.oss-cn-beijing.aliyuncs.com/sdk_js/owsdk.js?v="<?php echo time();?>></script>
	<style type="text/css">
