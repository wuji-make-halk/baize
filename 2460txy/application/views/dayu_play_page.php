...
<head>
	...
	<script src='http://test.dayukeji.com/javascripts/games51_SDK.js'></script>
	<script src='http://test.dayukeji.com/javascripts/jquery-3.1.0.min.js'></script>

    <script src="/js/h.js" charset="utf-8"></script>
	<style type="text/css">
		html{height:80%;background-color:black;border:solid black 1px}
		.cgr{color:#5aff00;}
		.cy{color:#fff000;}
		.cw{color:white;}
		.bs1{
