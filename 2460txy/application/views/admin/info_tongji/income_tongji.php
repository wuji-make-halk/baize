...
<html style="height: 100%;">
		...
		<script type="text/javascript">
			$(function(){
				$("#reflash").click(function(){
					$("#reflash").hide();
					$.get(
						"/index.php/Admin_report_api/every_hour_date/0/0",
						{},
				...
				$("#search").click(function(){
					...
					var url = "/index.php/Admin_report_api/check_info?start=" + start + "&to="  +end +"&game_father_id="+game_father_id +"&platform="+platform ;
					// location.href=url;
					$.get(
                        url,
                        {},
								...
								for(var i = 0; i<=2000 ;i++){
									...
									if(data[i]){
										$("#first_row").after(
											...
											+"<td>"+ data[i]['new_user_create_role'] +"</td>"
											+"<td>"+ data[i]['new_pay_users'] +"</td>"
											+"<td>"+ data[i]['new_pay_money']/100 +"</td>"
											+"</tr>"
										);
									}
	...
	<!--右侧边导航栏 start-->
		<div class="col-md-1">
		  <?php $this->load->view('admin/admin_sub_menu', ['income' => true]); ?>
		</div>
	<!--右侧边导航栏 end-->
		...
		<div class="col-md-11 myborder">
			...
			<div class="alert alert-info " role="alert">
				<form action="">
					...
					<select class="form-control" style="width:150px;height:25px;" name="platform" id="platform" data-am-selected="{searchBox: 1}">
    ...
    ?>
        ...
        ?>
			...
			<div class="row">
				...
				<button type="button" id="reflash">刷新</button>
				</div>
			</div>
            <div id="all_income">
            </div>
			...
			<h4></h4>
				<table border="1" cellspacing="0" cellpadding="0" style="width:100%;height:auto;color:#000;background-color:#fff;">
					<tr id= "first_row">
						...
						<th style="padding:5px;">新增用户创角</th>
						<th style="padding:5px;">新增付费用户</th>
						<th style="padding:5px;">新增用户付费金额</th>
					</tr>
				</table>
