		...
		<script type="text/javascript">
			$(function(){
				$("#search").click(function(){
					...
					var game_father = $("#game_father").val();
                    ...
                    if(!orderid){
						...
						console.log("订单号合法");
						var url = "/index.php/Admin/change_scale?scale=" + orderid+"&game_father="+game_father+"&platform="+platform;
					}
					$.get(
                        url,
                        {},
	...
	<!--右侧边导航栏 end-->
		...
		<div class="col-md-11 myborder">
			<div class="container-fluid">
				 <h4 class="alert-info" style="background-color:#ffffff">FAKE</h4>
			</div>
			<!--搜索条件 start-->
			<br/>
			<br/>
    ...
    ?>
        ...
        ?>
			...
			<div class="row">
				<div class="col-md-6">
				比例:
				<input type='text' id='user_order_id'></input><p>%</p>
				<button type="button" id="search">修改</button>
				</div>
			</div>
			<br/>
			<br/>
