		...
		<script type="text/javascript">
			$(function(){
				$("#search").click(function(){
                    ...
                    var url = "/index.php/Admin_report_api/daily_income?start=" + start + "&to="  +end +"&game_father_id="+game_father_id +"&platform="+platform ;
					// location.href=url;
					$.get(
                        url,
                        {},
                        function (response,status,xhr) {
                            ...
                            if(response.c == 0){
								...
								for(var i = 0; i<=2000 ;i++){
									...
									if(data[i]){
										var money= data[i]['order_count']/100;
										// var m_r = 0;
										// var m_l = 0;
										// if(data[i]['renshu']!=0){
										// 	m_r=money/data[i]['renshu'];
										// }
										// if(data[i]['login_count']!=0){
										// 	m_l=money/data[i]['login_count'];
										// }
										$("#first_row").after(
											"<tr class = 'info_table'>"+"<td>"+ data[i]['create_day'] +"</td>"
											+"<td>"+ data[i]['platform']+"</td>"
											+"<td>"+ data[i]['login_count']+"</td>"
											+"<td>"+ data[i]['careateRole_count']+"</td>"
											+"<td>"+ data[i]['signCreate_count'] +"</td>"
											// +"<td>"+ data[i]['renshu'] +"</td>"
											// +"<td>"+ data[i]['cishu'] +"</td>"
											// +"<td>"+ m_r +"</td>"
											// +"<td>"+ m_l +"</td>"
			...
			<h4></h4>
				<table border="1" cellspacing="0" cellpadding="0" style="width:100%;height:auto;color:#000;background-color:#fff;">
					<tr id= "first_row">
						...
						<!-- <th style="padding:5px;">arppu(总额/充值人数)</th> -->
						<!-- <th style="padding:5px;width:100px">arppu(总额/登录人数)</th> -->
