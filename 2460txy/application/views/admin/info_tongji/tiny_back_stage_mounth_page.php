...
<html style="height: 100%;">
		...
		<script type="text/javascript">
			$(function(){
				$("#search").click(function(){
                    ...
                    var url = "/index.php/Admin_backstage/get_data_by_mounth?start=" + start + "&to="  +end +"&game_father_id="+game_father_id +"&platform="+platform ;
					// location.href=url;
					$.get(
                        url,
                        {},
	...
	<!--右侧边导航栏 start-->
		<div class="col-md-1">
		  <?php $this->load->view('admin/tiny_admin_backstage_menu', ['mounth' => true]);?>
		</div>
	<!--右侧边导航栏 end-->
