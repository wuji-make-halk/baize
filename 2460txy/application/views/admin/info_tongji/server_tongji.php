...
<html style="height: 100%;">
		...
		<script type="text/javascript">
			$(function(){
				$("#search").click(function(){
					...
					var url = "/index.php/Admin_report_api/get_server_info?start=" + start + "&end="  +end +"&game_father_id="+game_father_id +"&platform="+platform ;
					// location.href=url;
					$.get(
                        url,
                        {},
                            ...
                            if(response.c == 0){
								...
								$.each(data,function(i,v){
									...
									$("#first_row").after(
										...
										+"<td>"+ v['money']/100+"</td>"
										+"<td>"+ v['new_pay_user_sum']+"</td>"
										+"<td>"+ v['new_user_sum_money']/100+"</td>"
										+"<td>"+ v['new_user_sum_create_role']+"</td>"
	...
	<!--右侧边导航栏 start-->
		<div class="col-md-1">
		  <?php $this->load->view('admin/admin_sub_menu', ['server' => true]); ?>
		</div>
	<!--右侧边导航栏 end-->
			...
			<h4></h4>
				<table border="1" cellspacing="0" cellpadding="0" style="width:100%;height:auto;color:#000;background-color:#fff;">
					<tr id= "first_row">
						...
						<th style="padding:5px;">新增付费人数</th>
						<th style="padding:5px;">新增付费总额</th>
						<th style="padding:5px;">新增创角</th>
					</tr>
				</table>
