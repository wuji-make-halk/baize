...
<html style="height: 100%;">
		...
		<script type="text/javascript">
			$(function(){
				$("#search").click(function(){
					var url ="/index.php/Huawei_admin_backstage/get_ltv_info?start="+$("#start").val()+"&end="+$("#end").val()+"&platform="+"huawei"+"&server_id="+$("#server_id").val()+"&game_father_id="+$("#game_father_id").val();
					$.get(
                        url,
                        {},
	...
	<!--右侧边导航栏 start-->
		<div class="col-md-1">
		  <?php $this->load->view("admin/huawei/huawei_sub_menu", ['ltv'=>true]); ?>
		</div>
	<!--右侧边导航栏 end-->
