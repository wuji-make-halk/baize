...
function login() {
    ...
    $.post( "/index.php/Huawei_admin_backstage/admin_login", { user: user, password: password },null,"json")
      .done(function( data ) {
        //   console.log("data " + data);
          if(data.c == 0 ){
              window.location.href="/index.php/Huawei_admin_backstage/back_stage_page";
          } else {
