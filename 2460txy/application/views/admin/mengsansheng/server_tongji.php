...
<html style="height: 100%;">
		...
		<script type="text/javascript">
			$(function(){
				$("#search").click(function(){
					...
					var url = "/index.php/mengsansheng_admin_backstage/get_server_info?start=" + start + "&end="  +end +"&game_father_id="+game_father_id +"&platform="+platform ;
					// location.href=url;
					$.get(
                        url,
                        {},
	...
	<!--右侧边导航栏 start-->
		<div class="col-md-1">
		  <?php $this->load->view('admin/mengsansheng/wenxian_sub_menu', ['server' => true]); ?>
		</div>
	<!--右侧边导航栏 end-->
