...
<head>
    ...
    <script src='/js/jssdk/tvmgame_g2b.js?v=<?php echo time(); ?>'></script>
    <script src="/js/h.js" charset="utf-8"></script>

	<script src="//static.yx.tvyouxuan.com/open/assets/js/internal.min.js" charset="utf-8"></script>
	<!-- <script src="//open.std.tvmopt.com/assets/js/internal.js" charset="utf-8"></script> -->
	<style type="text/css">
