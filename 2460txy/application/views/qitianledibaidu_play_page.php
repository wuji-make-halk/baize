...
<head>
    ...
    <script src='/js/jssdk/qitianledibaidu_g2b.js?v=6'></script>
    <script src="/js/PV_count/h_<?php echo $game->game_father_id ?>.js" charset="utf-8"></script>
    <script type="text/javascript" defer="defer" src="http://static.duoku.com/h5sdk/v1.min.js"> </script>
    <style type="text/css">
        html {
            height: 100%;
...
<body scroll='no' style='background-color:white'>
    ...
    <!-- <script type="text/javascript"  src="http://static.duoku.com/h5sdk/v1.min.js"></script> -->
</body>
