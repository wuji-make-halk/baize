...
<head>
    ...
    <script src='/js/jssdk/duohaowan_g2b.js?v=<?php echo time(); ?>'></script>
    <script src="/js/PV_count/h_<?php  echo $game->game_father_id?>.js" charset="utf-8"></script>
	<script src="/js/cp_js/jquery-1.9.1.min.js"></script>
	<script src="/js/cp_js/func.js"></script>
	<script src="/js/cp_js/dhw.js"></script>
	<style type="text/css">
