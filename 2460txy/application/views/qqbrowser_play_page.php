...
<head>
	...
	<script type='text/javascript' src='http://res.imtt.qq.com/html5game/api/js/qbh5-1.0.0-min.js'></script>
    <script src='/js/jssdk/qqbrowser_g2b.js?v=<?php echo time()?>'></script>
