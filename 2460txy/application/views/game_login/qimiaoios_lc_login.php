...
<head>
    ...
    <!-- <script src="//sdkv2.52wan.dkmol.net/www/js/aksdk.js" charset="utf-8"></script> -->
    <style type="text/css">
        #gbox {
            background: url('//js.2460.xileyougame.com/img/login/feiwanba/fantastic/lcby_mscq_D.jpg');
        }
        .off {
            width: 60px;
            height: 60px;
