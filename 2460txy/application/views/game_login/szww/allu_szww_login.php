...
<head>
    ...
    <style type="text/css">
        #gbox {
            background: url(http://img.2460.xileyougame.com/img/login/szww/szww_login.png);
        }
        ...
        .mainbg {
            background: url(http://img.2460.xileyougame.com/img/login/szww/login_icon/titlebg.png);
            width: 320px;
            height: 133px;
            position: relative;
            margin: auto;
        ...
        .enter {
            background: url(http://img.2460.xileyougame.com/img/login/szww/login_icon/enter.png);
            width: 127px;
            height: 39px;
        }
        ...
        .choosebg {
            background: url(http://img.2460.xileyougame.com/img/login/szww/login_icon/sverBg.png);
        ...
        .announce {
            background: url(http://img.2460.xileyougame.com/img/login/szww/login_icon/announce.png);
            width: 110px;
            height: 110px;
        }
...
<body style='margin:0px;padding:0px;-webkit-tap-highlight-color: rgba(0,0,0,0);height:0px;'>
    <div id='gbox' style='position:relative;width:480px;height:800px;overflow:hidden;display:none;'>
        ...
        <div style='' class='tc mainbg'>
            ...
            <div class='ma cw fs3' style='width:310px;height:35px;line-height:70px;position:relative' onclick='showAll();'><?php
            ...
            // };
            ?><div class='enter ma' style='margin-top:40px' onclick='jumpTo(<?php //echo $jumpto_status?>,"<?php //echo $url."&serverId=$default_server_id&server_name=$default_server_name&pfid=$default_server_pfid"?>",<?php  //echo $default_server_id?>);'></div><?php
        ...
        <div id='all' class='pa choosebg' style='display:none;'>
            ...
            <div id="scrollwrap" style='position:absolute;width:55%;height:65%;top:90px;left:39%;overflow:scroll;overflow-x: hidden;' class='tc bd'>
                ...
                //             'status' => $one->status,
                //         );
                //         $this->load->view('game_login/szww/server_row_temp', $sub_data);
                //     }
                // }
                //
