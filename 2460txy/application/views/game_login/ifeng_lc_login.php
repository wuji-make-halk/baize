...
<head>
    ...
    <script src="https://js.2460.xileyougame.com/js/h.js" charset="utf-8"></script>
    <style type="text/css">
        #gbox {
            background: url('//img.2460.xileyougame.com/img/login/feiwanba/duokemeng/<?php echo $kemeng_pkg ?>.jpg');
        }
        .off {
            width: 60px;
            height: 60px;
