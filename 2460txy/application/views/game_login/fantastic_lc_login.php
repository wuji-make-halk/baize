...
<head>
    ...
    <script src="//static.sh9130.com/js/aksdk.js" charset="utf-8"></script>
    <style type="text/css">
        #gbox {
            background: url('//js.2460.xileyougame.com/img/login/feiwanba/fantastic/<?php echo $pkg_name ?>.jpg');
        }
        .off {
            width: 60px;
            height: 60px;
