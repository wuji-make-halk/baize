...
<head>
    ...
    <script src="//picstatic.dkmol.net/js/aksdk.js" charset="utf-8"></script>
    <style type="text/css">
        #gbox {
            background: url('//js.2460.xileyougame.com/img/login/feiwanba/duokemeng/<?php echo $kemeng_pkg ?>.jpg');
        }
        .off {
            width: 60px;
            height: 60px;
            ...
            background: url(//js.2460.xileyougame.com/img/login/wb/weihu.png) no-repeat 0 0;
            /*-webkit-animation: hot 1000ms steps(1) infinite 0s;*/
        }
        .exit {
            background: url(//js.2460.xileyougame.com/passa/img/jzsc/exit.png);
            width: 62px;
            height: 82px;
            position: absolute;
            bottom: 110px;
        ...
        .joingroup {
            background: url(//js.2460.xileyougame.com/passa/img/jzsc/announce.png);
            width: 74px;
            height: 71px;
        }
        ...
        .mainbg {
            background: url(//js.2460.xileyougame.com/img/login/titlebg.png);
            width: 429px;
            height: 83px;
            position: relative;
            margin: auto;
        ...
        .item0 {
            background-image: url(//js.2460.xileyougame.com/img/login/itembg.png);
        ...
        .item1 {
            background-image: url('//js.2460.xileyougame.com/passa/img/jzsc/itemweihu.png');
            background-size: 100% 100%;
            width: 250px;
            position: relative;
            margin-top: 5px;
        ...
        .hot {
            ...
            top: -5px;
            pointer-events: none;
            background: url(//js.2460.xileyougame.com/passa/img/frames/hot.png) no-repeat 0 0;
            -webkit-animation: hot 1000ms steps(1) infinite 0s;
        }
        ...
        .new {
            ...
            top: -5px;
            pointer-events: none;
            background: url(//js.2460.xileyougame.com/passa/img/frames/new.png) no-repeat 0 0;
            -webkit-animation: hot 1000ms steps(1) infinite 0s;
        }
        ...
        .enter {
            background: url(//js.2460.xileyougame.com/img/login/enter.png);
            width: 281px;
            height: 80px;
        }

        .more {
            background: url(//js.2460.xileyougame.com/passa/img/jzsc/more.png);
        }

        .scrollbar {
            background: url(//js.2460.xileyougame.com/passa/img/jzsc/scrollbar.png);
        }

        .choosebg {
            background: url(//js.2460.xileyougame.com/img/login/feiwanba/sverBg.jpg);
            top: 0px;
            left: 0px
        }

        .tag {
            background: url(//js.2460.xileyougame.com/img/login/tag.png);
            width: 140px;
            height: 42px;
            line-height: 41px;
            font-size: 20px;
        ...
        .tagc {
            background: url(//js.2460.xileyougame.com/img/login/tagc.png);
            width: 140px;
            height: 42px;
        }
        ...
        .announcebg {
            background: url(//js.2460.xileyougame.com/passa/img/jzsc/annbg.jpg);
            position: absolute;
            top: 0px;
            left: 0px;
            width: 100%;
    ...
    <script type="text/javascript">
        var back_status=0;
        (function(window) {
            console.log('<?php echo 'pkgis '.$kemeng_pkg ?>');
            var params = {};
        ...
        function joinGroup() {
            // alert('get in joinGroup');
            // window.joinQQGroup('oUy0xk5gGM0mSbGq1z3fALHsRGZyrGcN');
            // alert(window.joinQQGroup('oUy0xk5gGM0mSbGq1z3fALHsRGZyrGcN'));
            var url = '//shang.qq.com/wpa/qunwpa?idkey=f526c6364bb7b4156d65bfef19c2155a2b268dd57309ffd54cdf21bca8e9ea15';
        	window.open(url);
        }
        ...
        function showHint() {
            ...
            var hintHtml = "<div style='margin:15% auto 6% auto;background:url(//opcdn.h5game.cn/nbsg/img/pass/portraitHint.png);background-size:100% 100%;width:" + (window.innerHeight / 640 * 324) + "px;height:" + window.innerHeight / 640 *
                204 + "px;'></div>";
...
<body style='margin:0px;padding:0px;-webkit-tap-highlight-color: rgba(0,0,0,0);height:0px;'>
    <div id='gbox' style='position:relative;width:480px;height:800px;overflow:hidden;display:none;'>
        ...
        <!-- <div class='joingroup' onclick='joinGroup()' style='position:absolute;top:100px;right:21px'></div> -->
