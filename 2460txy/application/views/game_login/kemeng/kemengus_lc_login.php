...
<head>
    ...
    <script src="http://sdkv2.52wan.dkmol.net/www/js/aksdk.js" charset="utf-8"></script>
    <style type="text/css">
        #gbox {
            background: url('http://img.2460.xileyougame.com/img/login/feiwanba/duokemeng/lcby_ssby_BD.jpg');
        }
        .off {
            width: 60px;
            height: 60px;
