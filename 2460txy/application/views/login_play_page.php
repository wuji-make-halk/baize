...
<head>
    ...
    <?php if ($game->game_father_id == 20002 || $game->game_father_id == 20022): ?>
    ...
    <script src='/js/g2b_loader.js?v=<?php echo time(); ?>'></script>
    <style type="text/css">
        html {
            height: 100%;
            ...
            if($game->game_father_id == 20020){
                if($game->game_name == '宇宙起源'){
                    echo 'background-image: url("//universe-client.plkjgame.com/resource/images/login/dl_datu._5e468.jpg");';
                }

                if($passId == 'dongxin'){
                    echo 'background-image: url("//universe-client.plkjgame.com/resource/images/login/dl_datu._5e468.jpg");';
                }else{
                    echo 'background-image: url("/img/login/huawei/cmdnx.jpg");';
                }
            }elseif($game->game_father_id == 20017 || $game->game_father_id == 20019){
                echo 'background-image: url("//cdn-hxxyh5.hxyxsj.com/version/hxxyh5/hxxy1.13.9a/resource/ui/image/dengLu/dl_dengLuDi01.jpg");';
            }elseif($game->game_father_id == 2){
    ...
    <script type="text/javascript">
        ...
        function loginClick(event) {
            ...
            if (!loginAccount || !password) {
                ...
                var url = "/index.php/allu_login/login?account=" + loginAccount + "&password=" + password;
            }
            this.g2b.getDataXHR(url, function (res) {
                if (res.c == 0) {
                    console.log(res.d);
                    g2blogin(res.d.account,res.d.password);
        ...
        function g2blogin(account,password){
...
<div id="loginBox" style="width:100%;height:100%;background-color:rgba(0,0,0,0.5);position: fixed;left:0;top:0;z-index:999999;" alt="遮罩">
...
<div alt="用户交互区">
<input id="loginAccount" style="font-size:14px;width:88%;height:40px;line-height:40px;margin:0 auto;margin-bottom:20px;border:none;border-bottom: 1px solid #ddd;display:block;padding:4px 10px;box-sizing:border-box;outline:none;border-radius:0;" type="text" name="" value="" placeholder="账号" alt="输入账号">
