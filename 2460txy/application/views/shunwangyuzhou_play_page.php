...
<body scroll='no' style='background-color:black'>
    ...
    <div id='qrcode_div' style="text-align:center;display:top:10%;padding:10px;display: none;background-color:white;z-index: 100;width: 300px;height: 300px;margin: auto;padding:10px;  position: relative;">
    <img id="id_qrcode" src="" alt="" style="border: 2px solid black;display: none;z-index: 101;width: 240px;height: 240px;margin: auto;  position: relative;" />
    <span>请使用支付宝或者微信扫描二维码支付</span>
    <div id="qrcode_close" style="color: white;
    line-height: 30px;
    height: 30px;
    width: 40%;
    font-size: 20px;
    ...
    text-align: center;
    cursor: pointer;
    background-color: orange;" alt="关闭按钮">继续游戏</div>
    </div>
