...
<head>
	...
	<script type="text/javascript">
        ...
        function testonresize(){
            ...
            var _frameWidth = document.documentElement.clientWidth||window.innerWidth;
            var _frameHeight = document.documentElement.clientHeight||window.innerHeight;
            document.getElementById('gameDiv').style.width = (_frameWidth>_frameHeight?_frameHeight*0.6:_frameWidth)+'px';
            document.getElementById('gameDiv').style.height = _frameHeight+'px';
            var gameFrame = document.getElementById('gameFrame');

            if(gameFrame){
                gameFrame.style.width = (_frameWidth>_frameHeight?_frameHeight*0.6:_frameWidth)+'px';
                gameFrame.style.height = _frameHeight+'px';
                // let chngameframediv = gameFrame.contentWindow.document.getElementById('chn-game-frame-div');
                // if(chngameframediv){
                // chngameframediv.style.width = (_frameWidth>_frameHeight?_frameHeight*0.6:_frameWidth)+'px';
                // chngameframediv.style.height = _frameHeight+'px';
            // }
            }
...
<body scroll='no' style='background-color:black' onresize='testonresize()'>
