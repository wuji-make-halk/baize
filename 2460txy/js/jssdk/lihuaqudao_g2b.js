var g2b = function () {
    ...
    var baidupostMessage = function (msg, d) {
        var data = {};
        // data.identify = "g2460";
        data.msg = msg;
        data.data = d;
            ...
            if (msg.identify && msg.identify == "g2460") {
                ...
                switch (msg) {
                    ...
                    case 'shareok': // qunhei
                        ...
                        break;
                    default:
                        // window.postMessage(msg, 'http://h5sdk.zytxgame.com');
    ...
    var login = function (res, cb) {
        ...
        var code = (res && res.code) || getParameter("code");
        ...
        if (passId == "lihuaqudao") {

            console.log("in lihuaqudao");

            var iframe = document.createElement('iframe');
            iframe.src = "http://openapi.baidu.com/oauth/2.0/authorize?response_type=code&client_id=hsbFuAkPwXRQSPUUb1Y4b8Nv&redirect_uri=http://h5sdk-xly.xileyougame.com/index.php/enter/play/lihuaqudao/1411&display=mobile&state=xxx";
            // iframe.src = "http://openapi.baidu.com/oauth/2.0/authorize?response_type=token&client_id=Qfa3MdU3MLTGIpB6HqTtF8zG&redirect_uri=http://h5sdk.zytxgame.com/index.php/enter/play/baidu/1117&scope=basic&display=popup&state=xxx";
    ...
    var init = function (data) {
        ...
        // } else {
        // loadScript(passHost + "/js/platform.js", function() {
