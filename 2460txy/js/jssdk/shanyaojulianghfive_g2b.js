var g2b = function () {
    ...
    var getScreenInfo = function () {
        var fHeight = document.documentElement.clientHeight || window.innerHeight || window.frameHeight;
        console.log(fHeight);
    ...
    var createIframe = function (src, id, tgt) {
        ...
        ifm.style.top = "0";
        ifm.style.left = "0";
        ifm.style.backgroundColor = "black";
        ifm.id = id;
        ifm.frameborder = "no";
    ...
    var initMessageListener = function () {
        ...
        window.addEventListener("message", function (e) {
            var msg = e.data;
            console.log("msg got " + JSON.stringify(msg));
            if (msg.identify && msg.identify == "g2460") {
                switch (msg.msg) {
                    ...
                    case MESSAGES.SET_SHARE:
                        ...
                        pf_obj.showShare();
                        break;
                    case MESSAGES.WEIBO_SHARE:
                        pf_obj.weiboShare(msg.data);
                        break;
    ...
    var login = function (res, cb) {
        ...
        if (passId == "shanyaojulianghfive") {
            var focus_url = "//" + location.host + "/index.php/api/focus/" + passId + "/" + appId + "?token=" + getParameter("token");
            getDataXHR(focus_url, function (response) {
                if (response.c == 0) {
                    var productCode = response.d.productCode; //QuickSDK后台自动分配
                    var productKey = response.d.productKey; //QuickSDK后台自动分配
                    var channelId = response.d.channel_id; //渠道号
                    var user_id = response.d.user_id; //渠道号

                    loadScript("https://sdkapi02.quicksdk.net/static/lib/libQuickSDK.js", function () {

                        QuickSDK.init(productCode, productKey, true, channelId);
                        res['user_id'] = user_id;
                        pf_params = res;
                        ...
                        getDataXHR(url, function (data) {
                            if (data.c == 0) {
                                ...
                                if (data.d.orientation == "landscape") {
                                    ...
                                    document.getElementById("gameDiv").style.marginTop = "0px";
                                    document.getElementById("gameDiv").width = "100%";
                                    document.getElementById("gameDiv").style.height = "0px";
                        ...
                        //     console.log('xileyouxileyoumessage  qiehuan');

                        //     alert('qiehuan');
                        //     var message;
                        //     if (callbackData.status) {
                        //         message = 'GameDemo:QuickSDK登录成功: uid=>' + callbackData.data.uid;
                        //         var user_id = callbackData.data.uid;
                        ...
                        // });
                        // QuickSDK.setLogoutNotification(function (callbackData) {
                        //     location.reload();
                        // });
            ...
            getDataXHR(url, function (data) {
                if (data.c == 0) {
                    ...
                    gameFrame.onload = function () {
                        ...
                        document.getElementById("loader").style.display = "none"
                        // document.getElementById("loader").style.heigth = "0px"
                    };
                    // gameFrame.attachEvent("onload", function() {
                    //     console.log("gameFrame loaded_ ");
                    //     if (!isListenerInited) {
                    //         initMessageListener();
                    //         isListenerInited = true
                    //     }
    ...
    var init = function (data) {
        ...
        // if (data.test) {
        passHost = "//" + location.host;
        // } else {
        // passHost = "//h5sdk.zytxgame.com";
        // }
        // if (data.test) {
        loadScript("//" + location.host + "/js/platform.js?v=" + new Date().getTime(), function () {
            loadScript("//" + location.host + "/js/platforms/PLATFORM_" + passType + ".js?v=" + new Date().getTime(), function () {
        ...
        // }
        // else {
        //     loadScript("https://h5sdk.cdn.zytxgame.com/js/platform.js", function() {
        //         loadScript("https://h5sdk.cdn.zytxgame.com/js/platforms/PLATFORM_" + passType + ".js?v=" + new Date().getTime(), function() {
        //             pf_obj = new pf(g2b, shareInfo, pf_params, {
        //                 appId: appid,
        //                 passId: passId,
        //                 gameId: gameId
