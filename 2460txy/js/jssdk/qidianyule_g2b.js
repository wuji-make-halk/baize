var g2b = function () {
    ...
    var login = function (res, cb) {
        ...
        if (passId == "qidianyule") {

            loadScript('//h5.qidianyule.com/Public/static/huosdk/huoh5sdk.js?v=' + new Date().getTime(), function () {

                let user_id = getParameter("user_id");
                if (!user_id) {
                    xgGame.ready();
                    let jsondata = {game_appid:getParameter("game_appid"),sdkloginmodel:getParameter("sdkloginmodel"),channelExt:getParameter('channelExt')};

                    xgGame.loginSdk(jsondata, function (data) {
                        console.log(data);
