var g2b = function() {
    ...
    var login = function(res, cb) {
        ...
        if (passId == "maoeriostishenthree") {
            console.log('is maoer');


            var initEntity = {}
            initEntity.debug = false;
            initEntity.giftNotifyUrl = passHost + "/index.php/api/notify/" + passId + "/" + appId;
            CommonMrSdk.init(initEntity, new function() {
                this.onSuccess = function(responseData) { //处理回调成功逻辑
					console.log("maoer sdk init succ");
                    ...
                    CommonMrSdk.loginWithUI(new function() {
                        ...
                        this.onFail = function(mrError) {
							...
							console.log("maoer sdk login fail");
                        }
                    })
                }
                this.onFail = function(mrError) {
					console.log("maoer sdk init fail");
				}
            })
