var g2b = function() {
    ...
    var login = function(res, cb) {
        ...
        if (passId == "qitianledibaidu") {
            ...
            window.dk_sdk.ready({
                ...
                console.log('in');
                console.log(dk_sdk.getAccessToken());
                res['token'] = dk_sdk.getAccessToken().AccessToken;
                pf_params = res;
    ...
    var init = function(data) {
        ...
        loadScript("//" + location.host + "/js/platform.js", function() {
            loadScript("//" + location.host + "/js/platforms/PLATFORM_" + passType + ".js?v=2", function() {
