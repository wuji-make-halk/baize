function iframePay(cfg) {
	...
	this.createIframeBox = function(url) {
		...
		oDiv.style.cssText = "border-radius:20px;width:85%; height:40%;position:fixed;z-index:" + this.iframeBoxzIndex + ";overflow:hidden;left: 0px;top: 0;bottom: 0;right: 0;margin: auto;";
		...
		oScript.setAttribute("allowTransparency","true");
		oScript.style.cssText = "background-color:transparent;width:100%; height:100%;border:0";
		oScript.src = url;
	...
	this.createBack = function(onclose) {
		...
		acBack.style.cssText = "width:70px; height:30px;line-height: 30px;text-align:center;font-size:40px;color:#fff;position:fixed;border-radius:4px;right: 5%;top: 30%;fontFamily:Microsoft YaHei";
