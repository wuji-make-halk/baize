...
pf.prototype.pay = function(amount, orderData) {
    ...
    this.g2b.createPay({
        ...
        // alert(location.host);
        // alert(myOwnBri.pay(param.goodsName, generate_order_id, readl_money, generate_order_id));


        this.g2b.loadScript("http://h5.allugame.com/js/iframe.js", function() {
            var url = "http://" + location.host + "/index.php/api/sign_order/" + that.passData.passId + "/" + that.passData.appId + "?order_id=" + generate_order_id +
