...
pf.prototype.init = function() {
    ...
    this.g2b.loadScript('//game.hdfc333.com/hdfc333.js', function() {
        cpext = that.pf_params.extra;
        gid = that.pf_params.g_id;
...
pf.prototype.pay = function(amount, orderData) {
    ...
    this.g2b.createPay({
        ...
        if (cpext) {
            wxpay({
                "paytitle": param.goodsName,
                "pay": parseInt(readl_money),
                "extra": cpext,
                "gparams": JSON.stringify({'order':generate_order_id}),
                "_gameID": gid
