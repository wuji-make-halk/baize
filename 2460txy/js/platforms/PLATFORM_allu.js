...
pf.prototype.pay = function (amount, orderData) {
    ...
    this.g2b.createPay({
        ...
        this.g2b.loadScript("http://h5.allugame.com/js/iframe.js", function () {
            var url = "//" + location.host + "/index.php/api/sign_order/allu/" + that.passData.appId + "?order_id=" + generate_order_id +
...
pf.prototype.checkFocus = function (data) {
    ...
    var url = "//" + location.host + "/index.php/api/focus/allu?openid=" + data.openId;
    this.g2b.getDataXHR(url, function (response) {
        // if (response.d == 1) {
