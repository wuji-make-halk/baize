...
pf.prototype.init = function() {
    ...
    this.g2b.loadScript("//cdn.anjiu.cn/h5-sdk/js/yxfSDK.js", function() {
...
pf.prototype.pay = function(amount, orderData) {
    ...
    this.g2b.createPay({
        ...
        var url = "//" + location.host + "/index.php/api/sign_order/" + that.passData.passId + "/" + that.passData.appId +
            ...
            "&cpLevel=" + cpLevel;
        var params = {
            amount: readl_money, //金额(元)
            roleid: userId, //游戏角色id
            serviceid: param.ext, //充值服务器id
            productname: that.shareInfo.title, //充值的游戏名称
            attach: generate_order_id //游戏方扩展参数
        };
        YXFH5SDK.openPay(params); //调起支付
