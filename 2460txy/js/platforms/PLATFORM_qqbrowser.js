...
pf.prototype.init = function() {
    ...
    u = this.pf_params.userId;
    var that = this;
    this.g2b.loadScript("http://res.imtt.qq.com/html5game/api/js/qbh5-1.0.0-min.js", function() {
...
pf.prototype.pay = function(amount, orderData) {
  ...
  param.cproleid = orderData.cproleid;
    ...
    this.g2b.createPay({
        ...
        // alert(generate_order_id);
        // alert(readl_money);
        // alert(subject);
        myOwnBri.pay(generate_order_id, readl_money, subject);
        // this.g2b.getDataXHR("http://h5sdk.zytxgame.com/index.php/api/sign_order/" + passId + "/" + param.appId + "?userId=" + u + '&subject=' + subject + '&money=' + readl_money + '&order=' + generate_order_id, function(response) {
        //     if (response.c == 0) {
...
pf.prototype.reportData = function(data) {
    ...
    if (data.action == 'enterGame') {
        ...
        var roleid = data.roleid;
        var srvid = data.srvid;
        var url = "//h5sdk.zytxgame.com/index.php/api/sign_collect/qqbrowser/" + this.passData.appId + "?roleid=" + roleid + "&srvid=" + srvid;
        this.g2b.getDataXHR(url, function(response) {});
    }
};
