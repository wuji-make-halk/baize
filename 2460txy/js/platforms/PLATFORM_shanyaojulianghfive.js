...
pf.prototype.reportData = function (data) {
    ...
    if (data.action == 'enterGame') {
        ...
        QuickSDK.uploadGameRoleInfo(roleInfoJson, function (response) {
            ...
            if (response.status) {
                console.log('enterGame 提交信息成功!');
            } else {
                console.log('enterGame', response.message);
            }
        });
        ...
        QuickSDK.uploadGameRoleInfo(roleInfoJson, function (response) {
            console.log(response)
            if (response.status) {
                console.log('create_role 提交信息成功!');
            } else {
                console.log('create_role', response.message);
            }
        });
