...
pf.prototype.pay = function(amount, orderData) {
    ...
    this.g2b.createPay({
        ...
        // alert(goodsName);
        LLBridge.pay(generate_order_id, readl_money, readl_money,goodsName, generate_order_id, function() {
            //回调处理，注意这里支付为服务端异步通知，客户端无法知晓支付结果，这里只是支付行为处理完成的回调，可 能为用户关闭支付窗口
        });
