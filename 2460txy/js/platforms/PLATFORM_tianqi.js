...
pf.prototype.init = function() {
    ...
    var that = this;
    this.g2b.loadScript('https://sdk.4cgame.com/static/js/sdk-1.0.0/Sdk.js', function() {
        xxx = new H5sdk();
        // xxx.SDKhideBall(1);
        cpapp_id = that.pf_params.app_id;
        cpmemid = that.pf_params.mem_id;
...
pf.prototype.pay = function(amount, orderData) {
    ...
    this.g2b.createPay({
        ...
        var payData = {
            a: cpapp_id,
            i: param.ext, // 游戏区服信息
            k: param.goodsName, // 充值商品名称
            l: param.goodsName, // 充值商品描述
            m: generate_order_id, // 扩展参数
            o: readl_money, // 充值金额
            p: cpNickname, // 玩家角色
            v: userId, // 玩家ID
            x: 600, // client_id
            ao: param.ext, // 游戏区服ID
            ap: param.cproleid, // 角色ID
        };
        xxx.SDKpayInit(payData);
