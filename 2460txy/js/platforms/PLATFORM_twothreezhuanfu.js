...
pf.prototype.init = function() {
    ...
    this.g2b.loadScript('http://www.233h5.com/static/sdk/cy.sdk.js', function() {
...
pf.prototype.pay = function(amount, orderData) {
  ...
  param.cproleid = orderData.cproleid;
    ...
    this.g2b.createPay({
        ...
        var url = "//" + location.host + "/index.php/api/sign_order/" + passId + "/" + param.appId + "?order_id=" + generate_order_id +
...
pf.prototype.reportData = function(data) {
    ...
    if (data.action == 'enterGame') {
        ...
        var roleid = data.roleid;
        var srvid = data.srvid;
        var url = "//" + location.host + "/index.php/api/sign_collect/tttgame/" + this.passData.appId + "?roleid=" + roleid + "&srvid=" + srvid;
        this.g2b.getDataXHR(url, function(response) {});
    }
};
