...
pf.prototype.init = function() {
    ...
    cp_token = this.pf_params.token;
    cp_ps = this.pf_params.ps;

    this.g2b.loadScript("http://hb.xiaougame.com/client/js/gamepay.js", function() {
        // gamepay.ready(updateGold, [param1, param2]);
    ...
    this.g2b.createPay({
        ...
        this.g2b.getDataXHR(url, function(response) {
            if (response.c == 0) {
              ...
              var nonceStr = response.d.nonceStr; //32位随机字符串
              var timeStamp = response.d.timeStamp; //10位时间戳,精确到秒
              ...
              gamepay.gzhpay("http://hb.xiaougame.com/mobile/gameBuy", data);
            }
        });
