...
pf.prototype.pay = function(amount, orderData) {
  ...
  param.cproleid = orderData.cproleid;
	...
	this.g2b.createPay({
		...
		var url = 'http://h5sdk.zytxgame.com/index.php/api/sign_order/gamemouse/' + param.appId + '?amount=' + real_money + '&trade_no=' + generate_order_id + '&openId=' + orderData.openId + "&props_name=" + goodsName;

		this.g2b.getDataXHR(url, function(response) {
			if (response.c == 0) {
				//console.log(" jiuw pay info : ");
				var jump_to = "http://www.jywh5.com/media.php/Game/game_pay/?game_appid=" + response.d.game_appid + "&trade_no=" + generate_order_id + "&props_name=" + goodsName + "&amount=" + real_money + "&user_id=" + response.d.user_id + "&channelExt=" + response.d.channelExt + "&sign=" + response.d.sign;
...
pf.prototype.reportData = function(data) {
	...
	if (data.action == 'enterGame') {
		...
		var url = "//h5sdk.zytxgame.com/index.php/api/sign_collect/gamemouse/" + this.passData.appId + "?roleid=" + roleid + "&srvid=" + srvid;
		this.g2b.getDataXHR(url, function(response) {});
	}
};
