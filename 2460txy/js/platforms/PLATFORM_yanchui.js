...
pf.prototype.init = function () {
	...
	this.g2b.loadScript("http://h5.hammercn.com/static/sdk/cy.sdk.js", function () {
		...
		var params = {
			...
			share: {
				success: function () { /*分享好友成功回调*/
					console.log("share success"); //该方法仅供参考
					/*分享好友成功回调*/
...
pf.prototype.showShare = function () {
    ...
    */
	// 分享信息有点不对，现在分享功能暂时关闭。
	// console.log("title: " + that.shareInfo.title + " desc: " + that.shareInfo.desc + " imgUrl: " + that.shareInfo.imgUrl);
