...
pf.prototype.init = function() {
    this.g2b.getDataXHR('http://h5sdk.zytxgame.com/index.php/api/focus/qimiaoios/1111', function(response) {
        if (response.c == 0) {
            if (response.d.pf == 2) {
                isiOS = true;
            }
...
pf.prototype.pay = function(amount, orderData) {
  ...
  param.cproleid = orderData.cproleid;
    ...
    this.g2b.createPay({
        ...
        switch (readl_money) {
            case 6:
                appstoryid = 'com.zengyihui.scyx.801';
                break;
            case 30:
                appstoryid = 'com.zengyihui.scyx.802';
                break;
            case 328:
                appstoryid = 'com.zengyihui.scyx.803';
                break;
            case 648:
                appstoryid = 'com.zengyihui.scyx.804';
                break;
            default:
                appstoryid = 0;
                break;
        ...
        loadScript("http://static.sh9130.com/js/aksdk.js", function() {
...
pf.prototype.reportData = function(data) {
    ...
    if (data.action == 'enterGame') {
        ...
        var url = "//h5sdk.zytxgame.com/index.php/api/sign_collect/fantastic/" + this.passData.appId + "?roleid=" + roleid + "&srvid=" + srvid;
        this.g2b.getDataXHR(url, function(response) {});
    }
};
