...
pf.prototype.init = function () {
	...
	//	console.log('bz成功：',zjwdios_param);
	var that = this;
...
pf.prototype.reportData = function (data) {
	...
	if (data.action == 'enterGame') {
		...
		console.log('is_activity', zjwdios_param);
		if (zjwdios_param['ext']['is_activity'] && zjwdios_param['ext']['is_activity'] > 0) {
			return 1;
		} else {
			return 0;
		}
