...
pf.prototype.init = function () {
    ...
    var that = this;
    that.g2b.loadScript('//youxicdn.tangdaoya.com/sdk/tdysdkV1.min.js', function () {
        cpToken = that.pf_params.tdytoken;
...
pf.prototype.pay = function (amount, orderData) {
    ...
    this.g2b.createPay({
        ...
        var url = "//" + location.host + "/index.php/api/sign_order/" + that.passData.passId + "/" + that.passData.appId +
            ...
            "&tdyid=" + userId +
            "&tdytoken=" + cpToken +
            "&order_name=" + param.goodsName +
            "&cproleid=" + param.cproleid;
        this.g2b.getDataXHR(url, function (response) {
            if (response.c == 0) {
                var prepay_id = response.d
                TDYSDK.pay(prepay_id);
            }
        });
