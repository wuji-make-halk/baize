...
pf.prototype.init = function() {
    ...
    // myOwnBri.getAndroidInfo();
    // if (_Mac && _Imei && _androidId) {
    //     var androinInfo = {
    //         'mac': _Mac,
    //         'imei': _Imei,
    //         'androidId': _androidId
    //     }
    //     this.g2b.postMessage('androidInfo', JSON.stringify(androinInfo));
    //     // alert('1');
    //     errtimes = 100;
    // } else {
    //     setTimeout(function() {
    ...
    //                 this.g2b.postMessage('androidInfo', JSON.stringify(androinInfo));
    //                 errtimes = 100;
    //                 // alert(JSON.stringify(androinInfo));
    //                 // alert('2');
    //             }
    //         }
    //
...
pf.prototype.pay = function(amount, orderData) {
    ...
    this.g2b.createPay({
        ...
        // alert(location.host);
        this.g2b.loadScript("https://h5.allugame.com/js/iframe.js", function() {
            var url = "https://" + location.host + "/index.php/api/sign_order/" + that.passData.passId + "/" + that.passData.appId + "?order_id=" + generate_order_id +
            ...
            this.g2b.getDataXHR(url, function(response) {
                if (response.c == 0) {
                    if (response.d.agent == 1) {
                        ...
                        var jump_to = 'https://h5.allugame.com/index.php/api/order?' +
                            "uid=" + userId +
                            "&game_id=" + param.appId +
...
pf.prototype.checkFocus = function(data) {
    ...
    var url = "http://" + location.host + "/index.php/api/focus/allu?openid=" + data.openId;
    // this.g2b.getDataXHR(url, function(response) {
    // if (response.d == 1) {
...
function getAndroidId(androidId) {
