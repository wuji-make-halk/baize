...
pf.prototype.pay = function(amount, orderData) {
  ...
  param.cproleid = orderData.cproleid;
    ...
    this.g2b.createPay({
        ...
        var url = "http://h5sdk.zytxgame.com/index.php/api/sign_order/hiwan/" + param.appId + "?goodsName=" + encodeURIComponent(goodsName) +
            "&amount=" + real_money +
            "&roleName=" + roleName +
        ...
        this.g2b.getDataXHR(url, function(response) {
            if (response.c == 0) {
                Hwwsdk.pay(goodsName, real_money, roleName, callBackInfo, response.d);
            }
        });
        closePayWindow();
...
pf.prototype.reportData = function(data) {
    ...
    if (data.action == 'enterGame') {
        ...
        var url = "//h5sdk.zytxgame.com/index.php/api/sign_collect/hiwan/" + this.passData.appId + "?roleid=" + roleid + "&srvid=" + srvid;
        this.g2b.getDataXHR(url, function(response) {});
    }
};
