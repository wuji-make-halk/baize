...
pf.prototype.pay = function (amount, orderData) {
    ...
    param.platform = 'jianguo';
    var search = this.g2b.object2search(param);
    this.g2b.createPay({
        search: search
    }, function (res) {
        amount = amount/100;
        myOwnBri.pay(amount, param.goodsName, res.d.order_id, param.ext, param.cproleid,_nickName,_lv);
    });
};
...
pf.prototype.reportData = function (data) {
    ...
    if (data.action == 'enterGame') {
        ...
        myOwnBri.update(srvid,cproleid,data.rolename,level,1);
        ...
        myOwnBri.update(srvid,cproleid,data.rolename,0,2);
