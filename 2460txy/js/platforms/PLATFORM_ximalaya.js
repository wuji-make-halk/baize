    ...
    this.g2b.createPay({
        ...
        this.g2b.getDataXHR(url, function(response) {
            if(response.c==0){
                ...
                var obj = {
                    'game_id':response.d.game_id,
                    'client_id':response.d.client_id,
                    'secret_key':response.d.secret_key,
                    'sign_type':'RSA',
                    'out_trade_no':generate_order_id,
                    'total_fee':readl_money,
                    'token':response.d.access_token,
                    'user_id':response.d.uid,
