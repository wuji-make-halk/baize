...
pf.prototype.init = function() {
    ...
    this.g2b.loadScript("//union.2r3r.com/game/qhjssdk", function() {
...
pf.prototype.pay = function(amount, orderData) {
    ...
    this.g2b.createPay({
        ...
        var url = "//" + location.host + "/index.php/api/sign_order/qunhei/" + param.appId + "?money=" + readl_money +
...
pf.prototype.reportData = function(data) {
    ...
    if (data.action == 'enterGame') {
        ...
        var url = "//" + location.host + "/index.php/api/sign_collect/qunhei/" + this.passData.appId + "?roleid=" + roleid + "&srvid=" + srvid;
        this.g2b.getDataXHR(url, function(response) {});
    }
};
