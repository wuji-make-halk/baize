...
pf.prototype.pay = function(amount, orderData) {
    ...
    this.g2b.createPay({
        ...
        this.g2b.getDataXHR(url, function(response) {
            if (response.c == 0) {
                YYH5GameSDK.placeOrder({
                    sdkOrderId: generate_order_id,
                    amount: readl_money,
                    prodId: readl_money,
                    prodName: param.goodsName,
                    prodDesc: param.goodsName,
                    serverId: param.ext,
                    serverName: param.ext,
                    roleId: param.cproleid,
                    roleName: cpRoleName,
                    gameName: gameName,
                    extData: generate_order_id
                });
