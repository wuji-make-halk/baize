...
pf.prototype.init = function () {
    ...
    cpProductId = this.pf_params.product_id;
    ...
    this.g2b.createPay({
        ...
        this.g2b.getDataXHR(url, function (response) {
            if (response.c == 0) {
                ...
                var channel = 2;
                var pay_url = "https://game.stargame.com/pay/internal_pay?ext=" + generate_order_id + "&product_id=" + product_id + "&money=" + money + "&time=" + time + "&goodsname=" + goodsname + "&sign=" + sign + "&channel=" + channel;
