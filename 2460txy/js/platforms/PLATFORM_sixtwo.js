...
pf.prototype.pay = function(amount, orderData) {
  ...
  param.cproleid = orderData.cproleid;
    ...
    this.g2b.createPay({
        ...
        var url = 'http://h5sdk.zytxgame.com/index.php/api/sign_order/sixtwo/' + param.appId + '?money=' + real_money + '&openId=' + orderData.openId + '&extraparam=' + generate_order_id;

        this.g2b.getDataXHR(url, function(response) {
            if (response.c == 0) {
                console.log("sixtwo pay ");
                var jump_to = 'http://m.602.com/pay/index/pay?auth=' + response.d.auth +
...
pf.prototype.checkFocus = function(data) {
    if (this.pf_params.focus == 0) {
        this.h5gamecn.postMessage(this.h5gamecn.MESSAGES.FOCUS_RETURNSTATE, 0);
    } else if (this.pf_params.focus == 1) {
        this.h5gamecn.postMessage(this.h5gamecn.MESSAGES.FOCUS_RETURNSTATE, 1);
    } else {
        this.h5gamecn.postMessage(this.h5gamecn.MESSAGES.FOCUS_RETURNSTATE, -1);
    }
};
...
pf.prototype.reportData = function(data) {
    ...
    if (data.action == 'enterGame') {
        ...
        var url = "//h5sdk.zytxgame.com/index.php/api/sign_collect/sixtwo/" + this.passData.appId + "?roleid=" + roleid + "&srvid=" + srvid;
        this.g2b.getDataXHR(url, function(response) {});
    }
};
