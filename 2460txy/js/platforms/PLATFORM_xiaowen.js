    ...
    this.g2b.createPay({
        ...
        WebViewJavascriptBridge.callHandler(
            'pay', {
                ...
                "_goodsName": param.goodsName,
                "_goodsID": readl_money,
                "_cpOrder": generate_order_id,
            },
...
pf.prototype.reportData = function(data) {
    ...
    if (data.action == 'enterGame') {
        ...
        WebViewJavascriptBridge.callHandler(
            ...
            function(responseData) {
                console.log('login report ok ' + responseData);
            }
        );
        ...
        // myOwnBri.update(srvid, roleid, data.rolename, roleLevel);
