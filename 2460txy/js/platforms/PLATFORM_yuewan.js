...
pf.prototype.init = function() {
	...
	this.g2b.getDataXHR('http://h5sdk.zytxgame.com/index.php/api/focus/yuewan/1089', function(response) {
		if (response.c == 0) {
...
pf.prototype.reportData = function(data) {
	...
	if (data.action == 'enterGame') {
		...
		var url = "//h5sdk.zytxgame.com/index.php/api/sign_collect/yuewan/" + this.passData.appId + "?roleid=" + roleid + "&srvid=" + srvid;
		this.g2b.getDataXHR(url, function(response) {});
	}
};
