...
pf.prototype.init = function() {
    ...
    var that = this;
    cpGame = this.pf_params.game;
    cpUser = this.pf_params.user;
    cpTime = this.pf_params.time;
    ...
    cpServer = this.pf_params.server;
    this.g2b.loadScript('http://statics.youyuebook.com/js/pay/paygame.js', function() {
...
pf.prototype.pay = function(amount, orderData) {
  ...
  param.cproleid = orderData.cproleid;
    ...
    this.g2b.createPay({
        ...
        // });
        window.PlayGame.pay(cpGame, cpGameName, cpServer, userId, readl_money.toString(), readl_money.toString(), generate_order_id);
...
pf.prototype.checkFocus = function(data) {
    ...
    var url = "http://h5sdk.zytxgame.com/index.php/api/focus/" + this.passData.passId +"/" + this.passData.appId +  "?game=" + cpGame + "&user=" + cpUser + "&time=" + cpTime;
    this.g2b.getDataXHR(url, function(response) {
        if (response.c == 0) {
...
pf.prototype.showShare = function() {
    ...
    window.PlayGame.jsshare(cpGame);
}
