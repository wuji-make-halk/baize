...
//  //获取场景值
  var scene = function (){
  	var sceneVal = wx.getLaunchOptionsSync().scene;
    console.log("场景值为：",  sceneVal);
  }
...
//      if(this.getParameter('appid')!='wxef93db96e3d80021'){
...
//      }
	...
	//                  if(open_id=='o-pHc4qy1m3bU1FGSYrhH20Insj0' && appid=='wx576cd9788a2a9c91'){
            ...
            // return 'https://h5sdk-xly.xileyougame.com/img/wxOrder/' + res.d.qrcode + '.png';
        });
    }
